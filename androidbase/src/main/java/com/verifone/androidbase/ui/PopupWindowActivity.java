...
public class PopupWindowActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.btn_position_pw:
                ...
                break;
            case R.id.btn_open:
                Toast.makeText(PopupWindowActivity.this, "Open", Toast.LENGTH_SHORT).show();
                mPopupWindow.dismiss();
                break;
            case R.id.btn_save_as:
                Toast.makeText(PopupWindowActivity.this, "Save as", Toast.LENGTH_SHORT).show();
                mPopupWindow.dismiss();
                break;
            case R.id.btn_close:
                Toast.makeText(PopupWindowActivity.this, "Close", Toast.LENGTH_SHORT).show();
                mPopupWindow.dismiss();
                break;
            case R.id.btn_edit:
                Toast.makeText(PopupWindowActivity.this, "Edit", Toast.LENGTH_SHORT).show();
                mPopupWindow.dismiss();
                break;
            case R.id.btn_cancel:
                Toast.makeText(PopupWindowActivity.this, "Cancel", Toast.LENGTH_SHORT).show();
                mPopupWindow.dismiss();
                break;
            case R.id.btn_share:
                Toast.makeText(PopupWindowActivity.this, "Share", Toast.LENGTH_SHORT).show();
                mPopupWindow.dismiss();
                break;
            case R.id.btn_collect:
                Toast.makeText(PopupWindowActivity.this, "Collect", Toast.LENGTH_SHORT).show();
                mPopupWindow.dismiss();
                break;
            case R.id.btn_exit:
                Toast.makeText(PopupWindowActivity.this, "Exit", Toast.LENGTH_SHORT).show();
                mPopupWindow.dismiss();
                break;
        }
    }
    ...
    private void showCenterPopupWindow() {
        ...
        ColorDrawable mColorDrawable = new ColorDrawable(0x66000000);
...
//         mPopupWindow.setAnimationStyle(android.R.style.Animation_Translucent);
        ...
        mPopupWindow.getBackground().setAlpha(100);//在0x66000000基础上再设置透明度(也可以不设置)
        ...
        View rootView = LayoutInflater.from(PopupWindowActivity.this).inflate(R.layout.activity_main, null);
